...
class ClubTournamentResult(Base):
    ...
    quarter_finalist_1 = Column(String(255), nullable=True)
    quarter_finalist_2 = Column(String(255), nullable=True)
    quarter_finalist_3 = Column(String(255), nullable=True)
    quarter_finalist_4 = Column(String(255), nullable=True)
    created_at = Column(DateTime, default=datetime.utcnow)
